...
// the tg-channel MCP pushes a notification (`← <channel>: …`). All
...
// (e.g. tg-channel) pushes a notification mid-session — `← <name>:
// <preview>`. The arrow is U+2190; the channel name is a kebab-case
// identifier in our world (`tg-channel`, `orgrimmar-inbox`, etc.).
//
