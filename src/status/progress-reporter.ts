...
// globs, and deferred-tool lookups are bookkeeping; the tg-channel MCP
...
export class ProgressReporter {
   ...
   * the tg-channel + recall MCP prefixes) update `lastActivityMs` upstream
